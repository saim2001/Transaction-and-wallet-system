...
Revision ID: fa84356f100b
Revises: 35be60aac0f8
Create Date: 2025-06-06 16:43:06.946253
...
revision: str = 'fa84356f100b'
down_revision: Union[str, None] = '35be60aac0f8'
...
def upgrade() -> None:
    ...
    sa.Column('purchase_type', sa.Enum('BY_CREDIT', 'BY_BUDGET', name='purchase_type_enum'), nullable=True),
